                                ...
                                ...)
{
  ...
  if(show.margins)
    {
      ## Column totals
      text(x=(1:nx) + nlabels.y*rowmar + 0.25 - 1,
           y=0.25,
      ...
      text(x=nx + nlabels.y*rowmar-0.25+width,
           y=(ny:1),
           labels=rowlabs,
           font=1,
           adj=c(1.0,0.5),
  ...
  ###
  segments(x0=nlabels.y*rowmar-0.25,
  ...
  ###
  segments(x0=(0:nx)+nlabels.y*rowmar-0.25,
  ...
  if(missing(ylab) || length(ylab)==0)
    text(x=((1:length(ylabs))-0.5)*rowmar-0.5,
         y=ny+0.5,
         labels=ynames,
         srt=colsrt,
         font=2,
    ...
    text(x=((1:length(ylab))-0.5)*rowmar-0.5,
         y=ny+0.5,
         labels=ylab,
         srt=colsrt,
         font=2,
  ...
  if(missing(xlab) || length(xlab)==0)
    text(x=nlabels.y*rowmar - 0.25 - strwidth(','),
  ...
  if(label.lines)
    {
      segments(x0=(0:nlabels.y)*rowmar-0.5,  # left: vertical lines
               x1=(0:nlabels.y)*rowmar-0.5,
               y0=0.5,
               y1=ny+0.5)
      segments(x0=nlabels.y*rowmar-0.25,     # top: horizontal lines
